...
`nflfastR` doesn't give data for live games and typing all the plays in by hand is annoying. So how does the 4th down bot work? With the ESPN API. To get the ESPN game ID, go to the [game page](https://www.espn.com/nfl/game?gameId=401220402) and look for the numbers at the end of the url. That's the game ID.
...
Note that the probabilities are slightly different here because ESPN has the wrong value for time remaining. This doesn't affect a lot of plays but is something to be aware of.
